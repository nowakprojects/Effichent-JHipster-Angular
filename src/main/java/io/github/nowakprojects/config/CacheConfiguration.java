package io.github.nowakprojects.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(io.github.nowakprojects.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(io.github.nowakprojects.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
